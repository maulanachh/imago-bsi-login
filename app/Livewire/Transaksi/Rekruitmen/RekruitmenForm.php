...
class RekruitmenForm extends Component
{
    ...
    public function selectJenisPekerjaan()
    {
        ...
        $this->jenis_pekerjaan = DB::table('ms_pekerjaan')
            ->where('ms_pekerjaan.level', '=', $userLevel + 1)
    ...
    public function goBack()
    {
        ...
        return redirect()->to('/transaksi/rekruitmen');
    }
    public function render()
    {
        return view('livewire.transaksi.rekruitmen.rekruitmen-form');
    }
}
