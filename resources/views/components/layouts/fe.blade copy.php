...
<head>
    ...
    <!-- Favicon -->
    <link href="assets/fe/img/favicon.ico" rel="icon">
    ...
    <link href="assets/fe/lib/animate/animate.min.css" rel="stylesheet">
    <link href="assets/fe/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="assets/fe/css/bootstrap.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <a href="/home" class="navbar-brand">
                    <img src="assets/fe/img/nasa.PNG" alt="Hairnic Logo" style="height: 100px;">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="/sign-in" class="nav-link d-none d-lg-inline-block ms-3" title="Sign In"
    ...
    <script src="assets/fe/lib/wow/wow.min.js"></script>
    <script src="assets/fe/lib/easing/easing.min.js"></script>
    <script src="assets/fe/lib/waypoints/waypoints.min.js"></script>
    <script src="assets/fe/lib/owlcarousel/owl.carousel.min.js"></script>
