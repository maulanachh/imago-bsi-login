                                ...
                                <div class="col-lg-4 col-md-6 mb-4 product">
                                    <div class="grid-inner">
                                        <div class="product-image mb-2">
                                            <a href="" wire:click.prevent="showDetail({{ $produk->produk_id }})">
                                                <img src="{{ asset('storage/' . $produk->produk_url) }}"
                                                    alt="{{ $produk->produk_name }}" class="img-fluid"
                                        ...
                                        <div class="product-desc text-center">
                                            <div class="product-title">
                                                <h3><a href="" class="color">{{ $produk->produk_name }}</a>
                                                </h3>
                                            </div>
                                            <div class="product-price fw-normal mt-0 mb-2">
                                                @if ($produk->diskon)
                                                    <del class="op-07">Rp
                                                        {{ number_format($produk->hargaProduk->first()->harga_jual, 0, ',', '.') }}</del>
                                                    <ins>
                                                        Rp
                                                        {{ number_format($produk->hargaProduk->first()->harga_jual * (1 - $produk->diskon / 100), 0, ',', '.') }}
                                                    </ins>
                                                @else
                                                    <ins>Rp
                                                        {{ number_format($produk->hargaProduk->first()->harga_jual, 0, ',', '.') }}</ins>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
