                ...
                @foreach ($produkList as $index => $produk)
                    <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="{{ 0.1 + $index * 0.2 }}s">
                        <div class="product-item text-center border h-100 p-4">
                            <img class="product-img img-fluid mb-4" src="{{ asset('storage/' . $produk->produk_url) }}"
                            ...
                            <a href="#" class="h6 d-inline-block mb-2">{{ $produk->produk_name }}</a>
                            <h5 class="text-primary mb-3">Rp
                                {{ number_format($produk->hargaProduk->first()->harga_jual, 0, ',', '.') }}</h5>
