                            ...
                            <div class="row gy-12">
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        @error('feature_code') <div class="alert alert-borderless alert-danger" role="alert">{{ $message }}</div> @enderror
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        @error('feature_name') <div class="alert alert-borderless alert-danger" role="alert">{{ $message }}</div> @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="form-check mb-2" style="margin-top: 12px;">
                                        ...
                                        @error('is_parent') <div class="alert alert-borderless alert-danger" role="alert">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div wire:ignore>
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        @error('feature_route_link') <div class="alert alert-borderless alert-danger" role="alert">{{ $message }}</div> @enderror
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        @error('feature_icon') <div class="alert alert-borderless alert-danger" role="alert">{{ $message }}</div> @enderror
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#feature_location').on('change', function(e) {
                ...
                @this.set('feature_location_id', feature_location_id);
            })
            //
            $('#feature_parent').on('change', function(e) {
                var feature_parent_id = $('#feature_parent').val();
                @this.set('feature_parent_id', feature_parent_id);
            })
            //
            $('#level').select2({
            ...
            $('#feature_side_bar').on('change', function(e) {
                ...
                @this.set('feature_side_bar_id', feature_side_bar_id);
            })
