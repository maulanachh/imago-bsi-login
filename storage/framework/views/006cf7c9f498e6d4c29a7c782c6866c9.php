        ...
        <div class="card card-height-100">
            ...
            <div class="col-lg-12">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Form Rekening Bank</h4>
                </div><!-- end card header -->
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <input wire:model="no_rekening" type="text" class="form-control">
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['no_rekening'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /var/www/html/jkhomestay/resources/views/livewire/master/rekening/rekening-form.blade.php ENDPATH**/ ?>