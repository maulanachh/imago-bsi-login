        ...
        <div class="card card-height-100">
            ...
            <div class="col-lg-12">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Form Stock Produk</h4>
                </div><!-- end card header -->
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <input wire:model="jumlah_stock" type="number" class="form-control">
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['jumlah_stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="col-12">
                                <table class="table table-nowrap">
                                    ...
                                    <tbody>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $data_stock_produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <th scope="row"><a href="#"
                                                        class="fw-semibold"><?php echo e($data->stockproduk_id); ?></a></th>
                                                <td><?php echo e($data->produk_name); ?></td>
                                                <td><?php echo e($data->pekerjaan_name); ?></td>
                                                <td><?php echo e($data->jumlah_stock); ?></td>

                                                <td>
                                                    <button wire:click="askDelete(<?php echo e($data->stockproduk_id); ?>)"
...
<?php /**PATH C:\laragon\www\ecommerce\resources\views/livewire/master/stock-produk/stock-produk-form.blade.php ENDPATH**/ ?>