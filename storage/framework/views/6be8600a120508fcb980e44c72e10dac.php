            ...
            <div class="col-xl-12">
                <div class="card card-height-100">
                    ...
                    <div class="card-body" wire:init="loadTableRSV">
                        <!--[if BLOCK]><![endif]--><?php if($isTableRsvLoaded): ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('transaksi.rsv-langsung.rsv-langsung-checkout-table', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-556579287-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /var/www/html/jkhomestay/resources/views/livewire/transaksi/rsv-langsung/rsv-langsung-checkout-index.blade.php ENDPATH**/ ?>