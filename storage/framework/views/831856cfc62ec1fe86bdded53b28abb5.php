                            ...
                            <div class="row gy-12">
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['charge_name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['charge_desc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /var/www/html/jkhomestay/resources/views/livewire/master/msops/extra-charge/extra-charge-form.blade.php ENDPATH**/ ?>