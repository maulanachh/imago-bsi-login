                            ...
                            <div class="row gy-12">
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['fnb_name'];
                                ...
                                <div class="col-md-6">
                                    <div>
                                        ...
                                        <select wire:model="jenisfnb_id" class="form-select mb-3"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $jenis_fnb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($id); ?>"><?php echo e($name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                        </select>
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['jenisfnb_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /var/www/html/jkhomestay/resources/views/livewire/master/f-n-b/fnb-form.blade.php ENDPATH**/ ?>