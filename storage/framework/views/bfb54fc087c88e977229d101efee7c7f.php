                                ...
                                <div class="row gy-12">
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['faq_question'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['faq_answer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\laragon\www\ecommerce\resources\views/livewire/master/faq/faq-form.blade.php ENDPATH**/ ?>