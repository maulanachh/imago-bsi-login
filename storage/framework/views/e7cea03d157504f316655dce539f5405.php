            ...
            <div class="col-lg-12">
                ...
                <div class="card-body mb-3">
                    ...
                    <ul class="nav nav-pills nav-primary mb-3" role="tablist">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link <?php echo e($activeTab === 'data_extra_charge' ? 'active' : ''); ?>"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="tab-pane <?php echo e($activeTab === 'data_extra_charge' ? 'active' : ''); ?>"
                                            ...
                                            <div class="col-md-2">
                                                <div>
                                                    ...
                                                    <select wire:model.live="charge_id" class="form-select mb-3"
                                                        ...
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $extra_charges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($id); ?>"><?php echo e($name); ?>

                                                            </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                                    </select>
                                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['charge_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            ...
                                            <div class="col-md-2">
                                                <div>
                                                    ...
                                                    <input wire:model="tarif_charge" type="number"
                                                        class="form-control" readonly>
                                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tarif_charge'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            ...
                                            <div class="col-md-1">
                                                <div>
                                                    ...
                                                    <input wire:model.lazy="qty_extracharge" type="number"
                                                        class="form-control" min="0">
                                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['qty_extracharge'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            ...
                                            <div class="col-md-2">
                                                <div>
                                                    ...
                                                    <input wire:model="total_extracharge" type="number"
                                                        class="form-control" readonly>
                                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['total_extracharge'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="col-12">
                                        <table class="table table-nowrap">
                                            ...
                                            <tbody>
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $data_bill_extracharge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <th scope="row"><a href="#"
                                                                class="fw-semibold"><?php echo e($bill->billextracharge_id); ?></a>
                                                        </th>
                                                        <td><?php echo e($bill->charge_name); ?></td>
                                                        <td>Rp. <?php echo e(number_format($bill->tarif_satuan, 0, ',', '.')); ?>
                                                        ...
                                                        <td>
                                                            <button type="button"
                                                                wire:click="askDeleteExtracharge(<?php echo e($bill->billextracharge_id); ?>)"
                                                                class="btn btn-ghost-danger waves-effect waves-light"><i
                                                                    class="bx bx-trash-alt"></i>delete</button>
                                                        </td> <!-- Format tanpa desimal -->
                                                    </tr>
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <select wire:model="charge_id_manual" class="form-select mb-3"
                                                            aria-label="Default select example">
                                                            <option value="">-- Pilih Item --</option>
                                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $extra_charges_manual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($id); ?>">
                                                                    <?php echo e($name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                                        </select>
                                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['charge_id_manual'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                            <div class="alert alert-borderless alert-danger"
                                                                role="alert"><?php echo e($message); ?></div>
                                                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input wire:model="tarif_charge_manual" type="number"
                                                            class="form-control">
                                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['tarif_charge_manual'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                ...
                                                <div class="col-md-2">
                                                    <div>
                                                        ...
                                                        <input wire:model="keterangan_charge" type="text"
                                                            class="form-control">
                                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['keterangan_charge'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div class="col-12">
                                            <table class="table table-nowrap">
                                                ...
                                                <tbody>
                                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $data_bill_extracharge_manual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <th scope="row"><a href="#"
                                                                    class="fw-semibold"><?php echo e($bill->billextrachargemanual_id); ?></a>
                                                            </th>
                                                            <td><?php echo e($bill->charge_name); ?></td>
                                                            <td>Rp. <?php echo e(number_format($bill->tarif, 0, ',', '.')); ?></td>
                                                            <!-- Format tanpa desimal -->
                                                            <td><?php echo e($bill->keterangan); ?></td>
                                                            <td>
                                                                <button type="button"
                                                                    wire:click="askDeleteExtrachargeManual(<?php echo e($bill->billextrachargemanual_id); ?>)"
                                                                    class="btn btn-ghost-danger waves-effect waves-light"><i
                                                                        class="bx bx-trash-alt"></i>delete</button>
                                                            </td> <!-- Format tanpa desimal -->
                                                        </tr>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($data_pembayaran_total_extracharge !== null): ?>
                                            <div class="col-md-12 mb-3">
                                                <div class=" bg-light">
                                                    <h5 class=" p-2 rounded"><b>Total Tarif Extra Charge</b> : Rp.
                                                        <?php echo e(number_format($data_pembayaran_total_extracharge, 0, ',', '.')); ?>

                                                    </h5>
                                                </div>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($data_pembayaran_total_extracharge_manual !== null): ?>
                                            <div class="col-md-12 mb-3">
                                                <div class=" bg-light">
                                                    <h5 class=" p-2 rounded"><b>Total Tarif Extra Charge Lainya</b> :
                                                        Rp.
                                                        <?php echo e(number_format($data_pembayaran_total_extracharge_manual, 0, ',', '.')); ?>
                                        ...
                                        <div class="row gy-4">
                                            <div class="col-md-12">
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                    <!--[if BLOCK]><![endif]--><?php if($stts_bill == 4 || $stts_bill == 3): ?>
...
<?php /**PATH /var/www/html/jkhomestay/resources/views/livewire/transaksi/rsv-langsung/rsv-langsung-form.blade.php ENDPATH**/ ?>