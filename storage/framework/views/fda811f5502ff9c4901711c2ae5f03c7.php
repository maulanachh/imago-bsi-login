    ...
    ============================================= -->
            <div class="section my-0 mt-lg-5">
                ...
                <div id="oc-products"
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $produkList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="oc-item">
                            <div class="product">
                                <div class="product-image mb-2"
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($produk->diskon > 0): ?>
                                ...
                                <div class="product-desc text-center">
                                    ...
                                    <div class="product-price fw-normal mt-0 mb-2">
                                        <!--[if BLOCK]><![endif]--><?php if($produk->hargaProduk && $produk->hargaProduk->harga_diskon): ?>
                                            <del class="op-07">Rp
                                                <?php echo e(number_format($produk->hargaProduk->harga_jual, 0, ',', '.')); ?></del>
                                            <ins>Rp
                                                <?php echo e(number_format($produk->hargaProduk->harga_jual, 0, ',', '.')); ?></ins>
                                        <?php else: ?>
                                            Rp
                                            <?php echo e(number_format($produk->hargaProduk->harga_jual, 0, ',', '.')); ?>
                ...
                <div class="container">
                    <div class="row g-0 align-items-md-stretch align-items-lg-center">
                        <div class="col-xl-7 col-md-6 img-overlap">
                            <img src="<?php echo e(asset('storage/' . $produk_url)); ?>" alt="<?php echo e($produk_name); ?>" class="h-100"
                        ...
                        <div class="col-xl-5 col-md-6 bg-white">
                            ...
                            <h2 class="display-6"><?php echo e($produk_name); ?></h2>
                            <p class="color">D<?php echo e($deskripsi_produk); ?></p>
                            <a href="#"
...
<?php /**PATH C:\laragon\www\ecommerce\resources\views/livewire/fe/home.blade.php ENDPATH**/ ?>